...
var aleph = {
  ...
  */
  ...
  margin: {
    line: {
      vs: { top: 75, bottom: 100, left: 185, right: 110 },
      sm: { top: 75, bottom: 100, left: 185, right: 110 },
      md: { top: 75, bottom: 100, left: 185, right: 110 },
      lg: { top: 75, bottom: 100, left: 185, right: 110 },
  ...
  colours: [
    "#7B67A8" /* OLD COLOURS - PRE FIX */,
    /* "#36BCEE",
    "#2EB5B2", */ "#2C56F7" /* NEW COLOUR - POST FIX */,
    "#2DE3E0" /* NEW COLOUR - POST FIX */,
    "#FDDD3E",
    "#EF7835",
    /* COMPLEMENTARY */
    "#E0D863" /* OLD COLOURS - PRE FIX */,
    /*   "#E0A463",
    "#E09063", */ "#F7C32D" /* NEW COLOUR - POST FIX */,
    "#FA823E" /* NEW COLOUR - POST FIX */,
    "#6863E0",
    "#63E0E0",
  ],
  coloursSubset: [],
  ...
  maxNumberOfLines: 5,
  axisMainTitles: {
    lineChart: { x: "Year", y: "Number of UK Population" },
    pyramidChart: { x: "Percentage of population in age band", y: "" },
  ...
  */
  ...
  toolTipDimensions: {
    /* dimension and positioning attributes for tooltip */ width: 600,
    height: 300,
    verticalLabelSpacing: 35 /* vertical spacing between text lines */,
    margin: { top: 100, right: 20, bottom: 5, left: 20 },
    informationArray: [] /* blank array to contain information estracted from ingested data file to display on tooltip */,
  ...
  lineChartXAxisRounding: 0,
  lineChartYAxisRounding: 5000000,
  selectionIndexes: {
    ethnicities: [],
    ageBands: [],
    genders: [],
  ...
  */
  ...
  xAxisMaximums: {
    ...
    roundings: { count: 100000, percent: 1 },
  },
