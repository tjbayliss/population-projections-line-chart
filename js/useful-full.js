...
function getIso3(input, i) {
  ...
  if (input.toLowerCase() == "saint kitts  nevis")
  ...
  if (input.toLowerCase() == "congo rep")
    input = "Congo, (Congo Â– Brazzaville)";
  if (input.toLowerCase() == "sao tome  principe")
    input = "Sao Tome and Principe";
  if (input.toLowerCase() == "turks and caicos is")
  ...
  if (
    input.toLowerCase() == "virgin islands us" ||
    input.toLowerCase() == "virgin islands, u.s."
  )
    input = "U.S. Virgin Islands";
  if (input.toLowerCase() == "n mariana is") input = "Northern Mariana Islands";
  if (
    input.toLowerCase() == "virgin islands british" ||
    input.toLowerCase() == "virgin islands, british"
  )
  ...
  if (input.toLowerCase() == "st vincent  grenadines")
    input = "Saint Vincent and the Grenadines";
  if (input.toLowerCase() == "palestine") return;
  if (input.toLowerCase() == "unknown") return;
  if (
    input.toLowerCase() == "sao tome  principe" ||
    input.toLowerCase() == "sao tome"
  )
    input = "Sao Tome and Principe";
  if (
    input == "CURAÃ‡AO" ||
    input == "Curaã‡ao" ||
    input.toLowerCase() == "curaçao"
  )
    return;
  if (input.toLowerCase() == "viet nam") input = "Vietnam";
  if (input.toLowerCase() == "congo dem. rep.") input = "Congo";
  if (input.toLowerCase() == "korea, south") input = "South Korea";
  if (input.toLowerCase() == "korea, democratic people's republic of")
    input = "North Korea";
  ...
  if (input.toLowerCase() == "south georgia and the south sandwich islands")
    return;
  if (input.toLowerCase() == "saint helena, ascension and tristan da cunha")
    return;
...
function getGeoRegion(input, i) {
  ...
  if (input.toLowerCase() == "n mariana is") input = "Northern Mariana Islands";
  if (input.toLowerCase() == "virgin islands british")
    input = "British Virgin Islands";
  if (input.toLowerCase() == "antigua  barbuda") input = "Antigua and Barbuda";
  if (input.toLowerCase() == "cabo verde") input = "Cape Verde";
